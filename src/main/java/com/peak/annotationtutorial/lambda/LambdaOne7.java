...
public class LambdaOne7 {
    public static void main(String[] args) {
        ...
        people.sort((o1, o2) -> o2.getLastName().toLowerCase().compareTo(o1.getLastName().toLowerCase()));
    ...
    private static void printConditionly(List<Person> people, Condition condition) {
        for (Person p:people){
            if (condition.test(p)){
